...
CubeSatDSE makes use of Architecture Design Space Graph (ADSG) and Multidisciplinary Design Optimization (MDO) methods, with a link oby Class Factory Evaluator (CFE).
